...
line(Spread(:,1),Spread(:,7),'LineWidth',1.5,'LineStyle','-.',...
    'Color','Magenta'); % Put 2
line(Spread(:,1),Spread(:,2),'LineWidth',1.5,'LineStyle','-',...
    'Color',[0.4,0.4,0.4]); % Bond
line(Spread(:,1),Spread(:,3),'LineWidth',1.5,'LineStyle','--',...
    'Color',[0.4,0.4,0.4]); % Forward
